    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-8 relative">
      <div className="bg-white shadow-lg rounded-lg p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          The nearby police are on their way. Your emergency contacts have been informed.
        </p>

        {/* Back to Home Button */}
        <button
          onClick={() => router.push("/userProfile")}
          className="bg-blue-500 text-white py-3 px-6 rounded-full font-semibold hover:bg-blue-600 transition"
        >
          Back to Home
        </button>
      </div>
